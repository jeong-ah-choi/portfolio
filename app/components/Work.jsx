...
const Work = ({ isDarkMode }) => {
  return (
    ...
    >
      ...
      >
        Welcome to my portfolio. Here are some of my latest projects. I hope you
        like them!
      </motion.p>
      ...
      >
        {workData.map((project, index) => (
          <motion.a
            ...
            className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group border border-gray-200 dark:border-none'
          >
